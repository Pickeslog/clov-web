...
// 인라인 CSS 변수로 못박아 다크에서도 라이트로 렌더한다. schedule.proto.css가 @scope를
// 쓰던 시절엔 "스코프 루트 자신엔 안 먹는" 함정을 우회하는 유일한 방법이었다(#345로
// @scope 제거됨) — 지금은 인라인 style이 CSS보다 항상 이겨서 그대로 안전하게 남겨둔다.
